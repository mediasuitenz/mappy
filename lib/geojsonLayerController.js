...
function buildGeojsonLayerOptions(options) {
  return {
    ...
    popupStyle: (properties) => options.popupPresenter.present(properties),
    popupFilter: (feature) => options.popupFilter.filter(feature),
    layerStyle: (properties) => options.layerStylePresenter.present(properties),
    iconStyle: (properties) => options.iconStylePresenter.present(properties),
    geojsonFilter: (feature)   => options.geojsonFeatureFilter.filter(feature),
