...
function buildConfigProcessingOptions(layer, config) {
  return {
    ...
    popupPresenter: config.popupPresenterFactory(nn(layer)('styles.popup')),
    popupFilter: config.filterFactory(nn(layer)('styles.popup.filter')),
    layerStylePresenter: config.stylePresenterFactory(nn(layer)('styles.layer')),
    iconStylePresenter: config.stylePresenterFactory(nn(layer)('styles.icon')),
